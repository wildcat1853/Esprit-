...
function Post({id, post, postPage}){
    ...
    return(
        ...
        {!postPage && (
            <img src={post?.userImg} alt="" className="h-11 w-11 rounded-full mr-4"></img>
        )}
        ...
        <div className="flex flex-col space-y-2 w-full">
            ...
            <div className={`flex ${!postPage && "justify-between"}`}>
                ...
                {postPage && (
                    <img src={post?.userImg} alt="Profile Pic" className="h-11 w-11 rounded-full mr-4"></img>
                ...
                <div className="text-[#6e767d]">
                    ...
                    <img src={post?.image} alt="" className="rounded-2xl max-h-[700px] object-cover mr-2"></img>
